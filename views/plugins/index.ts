...
import ytRaidersSql = require("../mysql/ytRaidersSql");
import OrderListen = require('../single/orderListhen');
import multipart = require('connect-multiparty');
import https = require("https");  
// import Login = require("./login");
import UserAuthsSql = require("../mysql/userAuthsSql");
import UserSql = require("../mysql/userSql");
import TransactionLogSql = require("../mysql/transactionLogSql");
...
function httpsGet(_url: string, callback: (data: string) => void): void{
    https.get(_url, res => {
        var recv = "";
...
class Index {
    ...
    public deleteCollection(input, req, res) 
    {
        var raidersList = new ytRaidersSql();
        var id = input['id'];
    ...
    //deleteClient
    public deleteClient(input, req, res) 
    {
        var raidersList = new ytRaidersSql();
        var id = input['id'];
    ...
    //获得用户信息
    public getUserInfo(input, req, res) 
    {
        var raidersList = new ytRaidersSql();
    ...
    //获得游记详情
    public getArticleInfo(input, req, res) 
    {
        var raidersList = new ytRaidersSql();
    ...
    //删除某一个文件
    public deleteFile(input, req, res) {
        //上一次的图片
        var url = input['url'];
        if(url){
    ...
    //获得意见反馈列表
    public getFeedbackList(input,req,res){
        var raidersList = new ytRaidersSql();
    ...
    //获得游记
    public getArticleList(input,req,res){
        var raidersList = new ytRaidersSql();
    ...
    //获得联系人详情
    public getClientInfo(input,req,res){
        var raidersList = new ytRaidersSql();
    ...
    //添加意见反馈列表
    public addFeedback(input,req,res){
        var raidersList = new ytRaidersSql();
    ...
    //添加收藏夹
    public addToCollection(input,req,res)
    {
        var raidersList = new ytRaidersSql();
    ...
    //编辑用户信息
    public editUserInfo(input, req, res) {
        var raidersList = new ytRaidersSql();
        //先获得列表
    ...
    //获得有用户信息的攻略列表
    public raidersList(input, req, res) {
        var raidersList = new ytRaidersSql();
        //先获得列表
    ...
    //订单列表
    public orderList(input, req, res) {
        var raidersList = new ytRaidersSql();
        //先获得列表
    ...
    //增加浏览量
    public addRaiderView(input, req, res) {
        var raidersList = new ytRaidersSql();
        var id = input['id'];
        //先获得列表
    ...
    //立即出发 活动列表
    public getActivityList(input,req,res) {
    ...
    //收藏列表
    public getCollection(input,req,res){
        var activityList = new ytRaidersSql();
        //先获得列表
    ...
    public getRecommendList(input,req,res){
    ...
    public editUserClientInfo(input,req,res)
    {
        var recommendList = new ytRaidersSql();
        var para = {};
        for(var option in input)
    ...
    public addUserClientInfo(input,req,res)
    {
        var recommendList = new ytRaidersSql();
        var para = {};
        for(var option in input)
    ...
    //获取当前登录的用户的顾客列表
    public getUserClientList(input,req,res){
        var recommendList = new ytRaidersSql();
    ...
    //下单时 选择的用户列表
    public getUserClientInfo(input,req,res){
    ...
    //下单时 活动的套餐列表
    public getpackageList(input,req,res){
    ...
    //获得商品列表
    public getGoodsList(input,req,res){
        var recommendList = new ytRaidersSql();
    ...
    //获得活动详情
    public getActivityInfo(input,req,res){
        var recommendList = new ytRaidersSql();
        var sendData = {};
        //再请求详情
    ...
    //生成游记
    public addArticle(input,req,res){
        var recommendList = new ytRaidersSql();
        var para = {};
    ...
    public editArticle(input,req,res)
    {
        var recommendList = new ytRaidersSql();
        var para = {};
    ...
    private _doWxPay(input, req, res) {
        ...
        var extra = {
            ...
            // bank_type:response-only,string
    ...
    private _doAliPay(input, req, res) {
      var orderId = input.orderId;
        var amount  = input.amount;
        var channel = input.channel;
            //支付宝支付
    ...
    public pay(input,req,res) {
        ...
        switch (channel) {
            case "wx_pub":
                this._doWxPay(input,req,res);break;
            case "alipay_wap":
                this._doAliPay(input,req,res);break;
        }
    }
    //PC端的注册
    public pcRegister(input,req,res) {
    ...
    public getCounponList(input,req,res) {
        var userId = input.userId;
        var raidersList = new ytRaidersSql();
    ...
    //取消订单
    public cancelOrder(input,req,res) 
    {
        var orderId = input.orderId;
    ...
    //删除订单
    public deleteOrder(input,req,res) 
    {
        var orderId = input.orderId;
        var raidersList = new ytRaidersSql();
    ...
    //评论
    public saveRecommend(input,req,res)
    {
        var recommendList = new ytRaidersSql();
        var para = {},orderId;
        for(var option in input)
    ...
    //确认行程结束
    public sureFinish(input,req,res) 
    {
        var orderId = input.orderId;
        var raidersList = new ytRaidersSql();
    ...
    //取消订单
    public isFirstOrder(input,req,res) 
    {
    ...
    public payCallback(input,req, res) 
    {
        var transLogSql = new TransactionLogSql();
    ...
    public chargeRetrieve(input,req, res) {
    ...
    public index(input: any, req: express.Request, res: express.Response): void {
