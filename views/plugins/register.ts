...
class Register {
    private _checkForm(input: any, req: express.Request, res: express.Response): {} {
    ...
    /////////////////////////////////////////////////////////////
    //获取验证码
    public getCode(input: any, req: express.Request, res: express.Response): void {
        var identifier = input.identifier;
    ...
    private _checkCode(input: any, req: express.Request, res: express.Response, callback: Function):void {
        var identifier = input.identifier;
        var code = input.code;
    ...
    public mobileRegister(input: any, req: express.Request, res: express.Response): void {
        var identityType = input.identityType;
        var identifier = input.identifier;
        var credential = input.credential;
