"use strict";
const myAppEditSql = require("../mysql/myAppEditsql");
const MyappListsql = require("../mysql/myappListsql");
class myappEdit {
    constructor() { }
    myAppAdd(input, req, res) {
        var name = input.name;
...
module.exports = myappEdit;
//# sourceMappingURL=myAppEdit.js.map