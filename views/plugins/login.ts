...
class Login {    
    ...
    _checkForm(input: any, req: express.Request, res: express.Response): boolean {
    ...
    _weixinAuthLogin (input: any, req: express.Request, res: express.Response): void {
        //检查用户是否已经登录
        ...
        httpsGet(url,(data: string) => {
            ...
            var source = THIRD_AUTHORIZE.weixin;
    ...
    _qqAuthLogin (input: any, req: express.Request, res: express.Response): void {
    }

    _weiboAuthLogin (input: any, req: express.Request, res: express.Response): void {
    }

    // authLogin(input: any, req: express.Request, res: express.Response): void {
    //     var source = input.source;
    //     switch(source) {
    //         case THIRD_AUTHORIZE.weixin:
    //         this._weixinAuthLogin(input, req, res);
    //         break;
    //         case THIRD_AUTHORIZE.qq:
    //         this._qqAuthLogin(input, req ,res);
    //         break;
    //         case THIRD_AUTHORIZE.weibo:
    //         this._weiboAuthLogin(input, req, res);
    //         break;
    //     }
    // }
}
